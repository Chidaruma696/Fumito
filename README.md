...
| --- | --- | --- |
| Tus repos, lenguajes, temas, estrellas, licencias y fechas por la API de GitHub | Qué es cada proyecto, a partir del primer párrafo útil de su README | Solo lo que GitHub no sabe: nombre a mostrar, puesto al que aspiras, correo, ciudad, web |
| El README de cada repo que marques | Tu stack real, ponderando bytes de código de todos los repos elegidos | Experiencia y formación, si quieres añadirlas |
| Tu perfil público para prellenar lo que pueda | Un borrador de resumen con tus lenguajes y temas, que editas o borras | Plantilla e idioma |
...
4. Corrige nombre, puesto, correo, ciudad, web y resumen. Añade experiencia y formación si quieres.
5. Elige plantilla (clásica o moderna) e idioma (español o inglés) y **Guardar PDF**. También puedes copiar el CV en Markdown o descargar tus datos en JSON para retomarlos en otro navegador.
...
└── cv.css       las plantillas del CV, siempre negro sobre blanco para imprimir
```
...
- **Habilidades**: suma de bytes por lenguaje en los repos elegidos, en porcentaje; se muestran las que pasan del 2 %.
